...
LEFT JOIN sys.dm_db_index_usage_stats u ON u.database_id = DB_ID() AND u.object_id = d.index_id
WHERE o.type <> 'IT' 
GO
/**/
...
LEFT JOIN sys.dm_db_index_usage_stats u ON u.database_id = DB_ID() AND u.object_id = i.index_id
OUTER APPLY (
