...
DECLARE @n nvarchar(50), @s nvarchar(1000), @PrintOnly int = 1
OPEN c
...
DECLARE @tabl nvarchar(50), @Card int, @Rg int, @Rw int, @s nvarchar(4000), @PrintOnly int = 1
OPEN c
...
ORDER BY Cardin 
DECLARE c CURSOR FOR SELECT Tabl, Cardin, Rang, RowCt FROM @T ORDER BY Cardin
DECLARE @tabl nvarchar(50), @Card int, @Rg int, @Rw int, @s nvarchar(4000), @s2 nvarchar(1000), @sp nvarchar(1), @PrintOnly int = 1
OPEN c
FETCH NEXT FROM c INTO @tabl, @Card, @Rg, @Rw
WHILE @@FETCH_STATUS = 0
BEGIN 
